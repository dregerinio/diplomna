...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        <div>
            @if (Route::has('login'))
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block" id="login-tray">
                    @auth
                    @else
        ...
        <div class="row" style="height:100%; margin:0;">
            <div class="col-2 text-center" id="sidebar">
                ...
                @auth
                <a href="{{ route('getProfileInfo') }}">
                    <div class="sidebar-row sidebar-button">
                        Profile
                    </div>
                </a>
